...
unlocked to sign the Zcoin-Qt.app bundle.
...
allowing somebody to distribute a Zcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the zcoin-qt.exe file inside the installer had not been tampered with.
