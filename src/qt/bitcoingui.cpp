...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/zcoin"));
    setWindowIcon(QIcon(":icons/zcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/zcoin"), tr("&About Zcoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/zcoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/zcoin_testnet"));
            setWindowIcon(QIcon(":icons/zcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/zcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::ZCS, nFeeRequired));
