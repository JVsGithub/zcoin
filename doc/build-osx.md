...
A zcoind binary is not included in the Zcoin-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of Zcoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Zcoin-Qt.app` is easy:
...
commands:
    ...
    echo -e "rpcuser=bitcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Bitcoin/zcoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Bitcoin/zcoin.conf"
...
Other commands:
    ...
    ./zcoind -daemon # to start the bitcoin daemon.
